  ...
  return (
    <>
      ...
      <div className="wrap">
        ...
        <p>Τα cookies είναι μικρά αρχεία κειμένου που αποθηκεύονται στη συσκευή σας όταν επισκέπτεστε έναν ιστότοπο.</p>
        <h2>Ποια Cookies Χρησιμοποιούμε</h2>
        <p><strong>Απαραίτητα cookies:</strong> Είναι απαραίτητα για τη βασική λειτουργία του ιστότοπου.</p>
        <p><strong>Cookies ανάλυσης:</strong> Μας βοηθούν να κατανοούμε πώς χρησιμοποιείτε τον ιστότοπό μας.</p>
        <h2>Διαχείριση Cookies</h2>
        <p>Μπορείτε να ελέγξετε και να διαγράψετε τα cookies μέσω των ρυθμίσεων του browser σας.</p>
      </div>
